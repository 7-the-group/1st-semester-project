...
/**
 * @brief Initialises PWM generation with a frequency of approx. 150Hz at PD3, PD5, PD6 (Manual, Timer1)
 **/
void pwm3_init(void);
 ...
 * @param[in] dutyPD3 Duty cycle in percent [0-255] (R)
 * @param[in] dutyPD5 Duty cycle in percent [0-255] (G)
